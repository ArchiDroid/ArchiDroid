...
if ! ADMOUNTED "$1"; then
	echo "Sorry, $1 partition is not available for your device, you can't change hardswap here"  # This will be useful e.g. for devices without external sd card
	exit 1
fi
